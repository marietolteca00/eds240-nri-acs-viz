...
ggplot(nri_counties, aes(x = national_risk_index_score_composite, 
  ...
  annotate("text", x = 25, y = 47, label = "National median", 
           hjust = -0.1, size = 3) +
  ...
  labs(x = "National Risk Index Score", 
       ...
       caption = "California counties have the highest median National Risk Index scores among U.S. states (median ≈ 95), nearly double the national median (≈ 50).\nData: FEMA National Risk Index (2025 Release).") +
